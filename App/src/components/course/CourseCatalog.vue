...
// Catalog grid + loading/error/empty/pagination states for the courses
// listing. Mirrors components/service/ServiceCatalog.vue's composition,
// adapted to course fields. Uses the vertical-rhythm classes (.section-y /
// .state-y) instead of hand-written py-* utilities -- see style.css's
// documented spacing contract.
defineProps({
...
<template>
  <section class="section-y bg-background">
    <div class="max-w-container-max mx-auto px-gutter">
      ...
      <!-- Empty -->
      <div v-else-if="!courses.length" class="state-y text-center">
