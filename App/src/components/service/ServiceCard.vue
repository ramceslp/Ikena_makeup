...
// Ported from frontend/src/components/service/ServiceCard.vue
// (mobile-capacitor-setup Phase 7). Uses the shared services/formatPrice.js
// util (Phase 5/6 convention) instead of the frontend's local
// `!num || num === 0 ? 'Gratis' : ...` duplicate — see formatPrice.js's
// file-level comment for why that local pattern silently mislabels a
// malformed/NaN price as "free".
