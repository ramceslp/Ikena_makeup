/**
 * Port of frontend/src/tests/trazoHeadings.test.js for App/'s home sections.
 *
 ...
 * template. App/ registers no directives at all, which is exactly why these
 * assertions are meaningful here: nothing could be adding the class at runtime.
 *
...
describe('trazo — scroll-scrubbed section headings (App)', () => {
   ...
   * text rather than of the block. The class is permanent, so a centred heading
   * needs `mx-auto` or it sits left for good.
   */
